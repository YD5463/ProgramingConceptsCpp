...
void AlbumManager::showPicture()
{
	...
	if (CreateProcess("C:\\Program Files\\IrfanView\\i_view64.exe", "C:\\Users\\magshimim\\Pictures\\newton2.PNG", NULL, NULL, TRUE, 0, NULL, NULL, &info, &processInfo))
	{
...
void AlbumManager::userStatistics()
{
	...
	std::cout << "user @" << userId << " Statistics:" << std::endl << "--------------------" << std::endl <<
		"  + Count of Albums owned: " << m_dataAccess.getAlbumsOfUser(user).size() << std::endl <<
